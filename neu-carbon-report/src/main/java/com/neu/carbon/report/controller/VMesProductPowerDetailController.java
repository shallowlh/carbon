...
public class VMesProductPowerDetailController extends BaseReportController {
    ...
    @DynamicResponseParameters(name = "carbonReportProductPowerReportList",
     ...
     */
    @GetMapping("/month")
    @ApiOperation("智造碳足迹-碳足迹管理-查询生产能耗月度报表")
    @DynamicResponseParameters(name = "carbonReportProductPowerReportMonth",
            properties = {@DynamicParameter(name = "total", value = "总记录数"),
                    @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
                    @DynamicParameter(name = "rows", value = "返回业务数据（数组类型）", dataTypeClass = VMesProductPowerDetail.class),
                    @DynamicParameter(name = "msg", value = "返回消息内容")})
     ...
     */
    @GetMapping("/year")
    @ApiOperation("智造碳足迹-碳足迹管理-查询生产能耗年度报表")
    @DynamicResponseParameters(name = "carbonReportProductPowerReportYear",
            properties = {@DynamicParameter(name = "total", value = "总记录数"),
                    @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
                    @DynamicParameter(name = "rows", value = "返回业务数据（数组类型）", dataTypeClass = VMesProductPowerDetail.class),
                    @DynamicParameter(name = "msg", value = "返回消息内容")})
    ...
    @DynamicResponseParameters(name = "carbonReportProductPowerReportDay",
            properties = {@DynamicParameter(name = "total", value = "总记录数"),
                    @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
                    @DynamicParameter(name = "rows", value = "返回业务数据（数组类型）", dataTypeClass = VMesProductPowerDetail.class),
                    @DynamicParameter(name = "msg", value = "返回消息内容")})
    ...
    @DynamicResponseParameters(name = "carbonReportProductPowerReportGet",
            properties = {
                    @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
