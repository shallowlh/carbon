...
public class BigScreenReport {
    ...
    @DynamicResponseParameters(name = "carbonReportSaleOverall", properties = {@DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
    ...
    @ApiOperation("客户销售排名")
    @DynamicResponseParameters(name = "carbonReportSaleCustomerRanking", properties = {@DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
    ...
    @GetMapping("/saleStat")
    @ApiOperation("销售统计")
    @DynamicResponseParameters(name = "carbonReportSaleStat", properties = {@DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
    ...
    @DynamicResponseParameters(name = "carbonReportSalePlanAchieveRate", properties = {
