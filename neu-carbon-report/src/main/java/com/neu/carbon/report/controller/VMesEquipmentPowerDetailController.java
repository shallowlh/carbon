...
public class VMesEquipmentPowerDetailController extends BaseController {
     ...
     */
    @GetMapping("/list")
    @ApiOperation("智造碳足迹-碳足迹管理-查询能耗数据采集报表")
    @DynamicResponseParameters(name = "carbonReportEquipmentPowerReportList",
     ...
     */
    @GetMapping("/day")
    @ApiOperation("智造碳足迹-碳足迹管理-查询能耗汇总报表")
    @DynamicResponseParameters(name = "carbonReportEquipmentPowerReportDay",
            properties = {@DynamicParameter(name = "total", value = "总记录数"),
                    @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
                    @DynamicParameter(name = "rows", value = "返回业务数据（数组类型）", dataTypeClass = VMesEquipmentPowerDetail.class),
                    @DynamicParameter(name = "msg", value = "返回消息内容")})
     ...
     */
    @GetMapping("/hour")
    @ApiOperation("智造碳足迹-碳足迹管理-查询设备小时能耗报表")
    @DynamicResponseParameters(name = "carbonReportEquipmentPowerReporthour",
            properties = {@DynamicParameter(name = "total", value = "总记录数"),
                    @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
                    @DynamicParameter(name = "rows", value = "返回业务数据（数组类型）", dataTypeClass = VMesEquipmentPowerDetail.class),
                    @DynamicParameter(name = "msg", value = "返回消息内容")})
    ...
    @DynamicResponseParameters(name = "carbonReportEquipmentPowerReportGet",
