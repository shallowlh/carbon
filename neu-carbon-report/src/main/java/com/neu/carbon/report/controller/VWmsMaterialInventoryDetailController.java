...
public class VWmsMaterialInventoryDetailController extends BaseController {
    ...
    @DynamicResponseParameters(name = "wmsReportMaterialInventoryDetailReportList",
            properties = {
    ...
    @DynamicResponseParameters(name = "wmsReportMaterialInventoryDetailReportGet",
            properties = {
                    @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
