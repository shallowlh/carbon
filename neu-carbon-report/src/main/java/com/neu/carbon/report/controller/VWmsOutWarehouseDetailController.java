...
public class VWmsOutWarehouseDetailController extends BaseController {
    ...
    @DynamicResponseParameters(name = "wmsReportOutWarehouseDetailReportList",
            properties = {
    ...
    @DynamicResponseParameters(name = "wmsReportOutWarehouseDetailReportGet",
            properties = {
                    @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
