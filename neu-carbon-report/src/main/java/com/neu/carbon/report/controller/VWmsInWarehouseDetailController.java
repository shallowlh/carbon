...
public class VWmsInWarehouseDetailController extends BaseController {
    ...
    @DynamicResponseParameters(name = "wmsReportInWarehouseDetailReportList",
            properties = {
    ...
    @DynamicResponseParameters(name = "wmsReportInWarehouseDetailReportGet",
            properties = {
                    @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
