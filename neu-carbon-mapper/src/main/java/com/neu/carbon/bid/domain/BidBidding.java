...
public class BidBidding extends BaseEntity
{
    ...
    private BidEnterpriseBidding enterpriseBidding;

    public BidEnterpriseBidding getEnterpriseBidding() {
        return enterpriseBidding;
    }

    public void setEnterpriseBidding(BidEnterpriseBidding enterpriseBidding) {
        this.enterpriseBidding = enterpriseBidding;
    }
