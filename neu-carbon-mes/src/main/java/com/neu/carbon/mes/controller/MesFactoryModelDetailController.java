...
public class MesFactoryModelDetailController extends BaseController {
    ...
    @DynamicResponseParameters(name = "mesModelFactoryModelDetailModelList", properties = {
    ...
    @DynamicResponseParameters(name = "mesModelFactoryModelDetailModelGet", properties = {
            @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
