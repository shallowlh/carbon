...
public class BidEnterpriseBiddingController extends BaseController {
    ...
    @DynamicResponseParameters(name = "bidEnterpriseBiddingList", properties = {
    ...
    @ApiOperation("查询企业投标列表用户接口")
    @DynamicResponseParameters(name = "bidEnterpriseBiddingFrontList", properties = {
            @DynamicParameter(name = "total", value = "总记录数"),
            @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
            @DynamicParameter(name = "rows", value = "返回业务数据（数组类型）", dataTypeClass = BidEnterpriseBidding.class),
            @DynamicParameter(name = "msg", value = "返回消息内容")
    ...
    @DynamicResponseParameters(name="bidEnterpriseBiddingGet", properties = {
            @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
    ...
    @ApiOperation("获取企业投标详细信息用户端接口")
    @DynamicResponseParameters(name="bidEnterpriseBiddingFrontGet",properties = {
            @DynamicParameter(name = "code", value = "状态码，200正确，其他错误"),
            @DynamicParameter(name = "data", value = "返回业务数据", dataTypeClass = BidEnterpriseBidding.class),
            @DynamicParameter(name = "msg", value = "返回消息内容")
    })
